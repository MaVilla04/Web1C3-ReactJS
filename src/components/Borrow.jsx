  ...
  return (
    <main className="container py-3 col-lg-8 min-vh-100">
      ...
      <table className="table">
        <thead>
          <tr>
            <th scope="col" className="text-body">Nombre</th>
            <th scope="col" className="text-body">Libro</th>
            <th scope="col" className="text-body">Autor</th>
            <th scope="col" className="text-body">Editorial</th>
            <th scope="col" className="text-body">Año</th>
